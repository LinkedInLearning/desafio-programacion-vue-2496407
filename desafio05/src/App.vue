    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="card-text">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="form-check">
                <input name="interna-empleados" class="form-check-input" type="checkbox" value="">
          ...
          <div class="mb-3 row">
            <label for="f-fin" class="col-sm-2 col-form-label">Fecha límite de planeación</label>
            <div class="col-sm-10">
              <input type="date" class="form-control" id="f-planeación">
            </div>
          </div>
